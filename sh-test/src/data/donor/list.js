...
export const list = [
  {
    ...
    highest_education_info: {
      degree: 'Master', major: 'Hospital Operation', school: 'Johns Hopkins University'
    },
    //学历
    education: [{
      degree: 'Master', major: 'Hospital Operation', school: 'Johns Hopkins University', start_date: '', end_date: '', remark: ''
    }],
    //婚姻状况
    ...
    character: 'good',//性格
    talent: 'Music', //天赋    //  输入框
    language: 'English',  //语言   //  输入框
    family_bald: 'no', //谢顶家人    //  输入框
    donation_reason: 'Money', //捐献原因    //  输入框
